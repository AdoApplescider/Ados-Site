var scene = new THREE.Scene(); //Three.js background
        ...
        var render = function () {
            ...
            motionRateX = motionRateX * 0.7 + distFromTargetX * 0.01; // damping
            motionRateY = motionRateY * 0.7 + distFromTargetY * 0.01; // damping
...
function pageTransition() {
    ...
    setTimeout(function () {
        window.location.href = "https://chestnutbread.neocities.org/main"; //Redirects to main page ../main.html
    }, 7000); //Make sure that this delay allows the animation to complete
}
